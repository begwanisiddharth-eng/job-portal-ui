        ...
        <div className="relative border-t border-gray-700/50 mt-16 pt-8">
          ...
          <div className="flex flex-col md:flex-row justify-between items-center">
            <div className="flex flex-wrap justify-center md:justify-start gap-6 text-sm text-gray-400 mb-6 md:mb-0">
              <span className="relative text-gray-400" title="Privacy Policy page is not available yet">
                <span className="relative z-10">Privacy Policy</span>
              </span>
              <span className="relative text-gray-400" title="Terms of Service page is not available yet">
                <span className="relative z-10">Terms of Service</span>
              </span>
              <span
                className="relative text-gray-400"
                title="We use cookies to improve your experience and analyze site traffic."
              >
